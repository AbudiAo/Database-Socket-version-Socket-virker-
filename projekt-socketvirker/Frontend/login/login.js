...
let userPasswordField = document.getElementById("insertPassword"); // Finder passwordfeltet ved login blanketten
userPasswordField.addEventListener("keyup", (e) => { // Funktionen til at logge ind ved at trykke enter
    if (e.key === "Enter") { // Hvis der trykkes enter, kaldes funktionen til at tjekke log ind
        e.preventDefault();
        userLogin();
    };
});

// Det samme gentages for blanketten til oprettelse af ny bruger
let newEmail = document.getElementById("signupE-mail");
let passwordcreation = document.getElementById("createPassword");
let passwordconfirmation = document.getElementById("repeatPassword");
...
const handleKeyUp = (e) => {
    ...
    newEmail.addEventListener("keyup", handleKeyUp);
    passwordcreation.addEventListener("keyup", handleKeyUp);
    passwordconfirmation.addEventListener("keyup", handleKeyUp);
